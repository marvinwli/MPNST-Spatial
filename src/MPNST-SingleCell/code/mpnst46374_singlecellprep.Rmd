---
title: "46374 mpnst single cell prep"
...
```{r}
dirpath <- "/projects/yegnalab-hpc/Marvin_Li/MPNST/CB01JHU525/CB01JHU525_000_analysis/cellranger/FLEX_46374/outs/per_sample_outs/FLEX_46374/count/sample_filtered_feature_bc_matrix/"
...
write.csv(
  top100_wide,
  file      = "/home/mli110/MPNST-Spatial/sc46374markers.csv",
  row.names = FALSE,
  quote     = FALSE
)
```
...
cluster_markers <- list(
  "Cluster_0: Macrophages (TAM/M2)"    = c("CD163", "C1QA",  "MRC1"),
  "Cluster_1: Tumor (nc-like)"         = c("SOX10", "S100B", "NGFR"),
  "Cluster_2: Tumor (nc-like)"         = c("SOX10", "S100B", "NGFR"),
  "Cluster_3: Stroma (CAF)"            = c("DCN",   "FAP",   "PDGFRA"),
  "Cluster_4: Dendritic cells"         = c("CD1C",  "CLEC10A","HLA-DRA"),
  "Cluster_5: Stroma (CAF)"            = c("DCN",   "FAP",   "PDGFRA"),
  "Cluster_6: CD8+ T cells"            = c("CD8A",  "GZMB",  "PRF1"),
  "Cluster_7: B cells"                 = c("MS4A1", "CD79A", "CD19"),
  "Cluster_8: Pericytes/Vascular SM"   = c("RGS5",  "PDGFRB","ACTA2"),
  "Cluster_9: Plasma cells"            = c("MZB1",  "JCHAIN","XBP1"),
  "Cluster_10: Endothelial"            = c("VWF",   "PECAM1","CDH5")
)
# ─────────────────────────────────────────────────────────────────────────────

pdf("/projects/yegnalab-hpc/Marvin_Li/MPNST/singlecell_figures/46374_Celltype_FeaturePlots.pdf", width = 20, height = 6)
...
```{r}
saveRDS(scseurat_filtered, file = "/projects/yegnalab-hpc/Marvin_Li/MPNST/MPNST singlecell rds objects/filtered_46374.RDS")
```