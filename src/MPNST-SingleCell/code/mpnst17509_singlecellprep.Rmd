---
title: "mpnst 17509 single cell prep"
...
```{r}
dirpath <- "/projects/yegnalab-hpc/Marvin_Li/MPNST/CB01JHU525/CB01JHU525_000_analysis/cellranger/FLEX_17509/outs/per_sample_outs/FLEX_17509/count/sample_filtered_feature_bc_matrix/"
...
write.csv(
  top100_wide,
  file      = "/home/mli110/MPNST-Spatial/sc17509markers.csv",
  row.names = FALSE,
  quote     = FALSE
)
```
...
cluster_annotations <- c(
  ...
  "1" = "Epithelial? cells",
  "2" = "Skeletal muscle",
  "3" = "Stroma(CAF-invasive)",
  "4" = "Skeletal muscle",
  "5" = "Tumor (hypoxia/stress response)",
  "6" = "Macrophages (TAM)",
  "7" = "CD8",
  "8" = "Endothelial"
)
...
cluster_markers <- list(
  ...
  "Cluster_1: Epithelial Contamination"     = c("EPCAM",  "KRT18",  "CDH1"),
  "Cluster_2: Myogenic Progenitors"         = c("PAX7",   "MYF5",   "MYOD1"),
  "Cluster_3: ECM-Remodeling CAF"           = c("CCN2",   "MMP2",   "SPARC"),
  "Cluster_4: Skeletal Myocytes"            = c("TNNT3",  "TTN",    "MYOG"),
  "Cluster_5: Hypoxic / Stress Tumor"       = c("VEGFA",  "CA9",    "SLC2A1"),
  "Cluster_6: Macrophages / TAMs"           = c("CD163",  "C1QA",   "CSF1R"),
  "Cluster_7: CD8⁺ Cytotoxic T cells"        = c("CD8A",   "GZMA",   "PRF1"),
  "Cluster_8: Vascular Endothelial Cells"   = c("CDH5",   "PECAM1", "VWF"),
  "Cluster_9: Neutrophils"                  = c("S100A8", "S100A9", "CXCR2"),
  "Cluster_10: Pericytes / Vascular SMCs"   = c("PDGFRB", "ACTA2",  "RGS5")
)
# ─────────────────────────────────────────────────────────────────────────────

pdf("/projects/yegnalab-hpc/Marvin_Li/MPNST/singlecell_figures/17509_Celltype_FeaturePlots.pdf", width = 20, height = 6)
...
```{r}
saveRDS(scseurat_filtered, file = "/projects/yegnalab-hpc/Marvin_Li/MPNST/MPNST singlecell rds objects/filtered_17509.RDS")
```