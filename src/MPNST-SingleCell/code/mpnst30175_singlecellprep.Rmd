---
title: "mpnst30175 single cell prep"
...
```{r}
dirpath <- "/projects/yegnalab-hpc/Marvin_Li/MPNST/CB01JHU525/CB01JHU525_000_analysis/cellranger/FLEX_30175/outs/per_sample_outs/FLEX_30175/count/sample_filtered_feature_bc_matrix/"
...
write.csv(
  top100_wide,
  file      = "/home/mli110/MPNST-Spatial/sc30175markers.csv",
  row.names = FALSE,
  quote     = FALSE
)
```
...
cluster_annotations <- c(
  ...
  "1" = "CD8 (partially exhausted)",
  "2" = "Macrophages (TAM)",
  "3" = "Tumor (mes-like)", #yap/hippo driven
  "4" = "Stroma (CAF)",
  "5" = "Tumor (hypoxic/stress response)",
  "6" = "Neutrophils"
)
...
cluster_markers <- list(
  "Cluster_0: Proliferative"            = c("MKI67",  "TOP2A",   "CDK1"),
  "Cluster_1: CD8+ T cells"             = c("CD8A",   "PRF1",    "GZMB"),
  "Cluster_2: TAMs (Macrophages)"       = c("CD163",  "MRC1",    "C1QA"),
  "Cluster_3: YAP-driven mesenchymal tumor" = c("YAP1",   "CCN1",   "CCN2"), 
  "Cluster_4: CAFs / Stromal fibroblasts"  = c("DCN",    "COL1A1",  "FAP"),
  "Cluster_5: Hypoxic/stress tumor"     = c("VEGFA",  "SLC2A1",  "HILPDA"),
  "Cluster_6: Neutrophils"              = c("S100A8", "FCGR3B",  "CXCR2")
)
# ─────────────────────────────────────────────────────────────────────────────

pdf("/projects/yegnalab-hpc/Marvin_Li/MPNST/singlecell_figures/30175_Celltype_FeaturePlots.pdf", width = 20, height = 6)
...
```{r}
saveRDS(scseurat_filtered, file = "/projects/yegnalab-hpc/Marvin_Li/MPNST/MPNST singlecell rds objects/filtered_30175.RDS")
```